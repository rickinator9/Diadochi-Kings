...
NDiplomacy = {
	...
	DEMESNE_BASE_MAX_SIZE = 3.0,				-- Base Max Demesne Size
	...
	DEMESNE_MAX_SIZE_KING_MULT = 5.0,			-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_EMPEROR_MULT = 6.0,		-- Extra Max Demesne Size from the ruler's rank
	...
	VASSAL_LIMIT_EMPEROR_MULT = 50.0, 			-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_GREAT_DUKE_BONUS = 5.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy
	VASSAL_LIMIT_DIPLOMACY_MULT = 0.75,			-- Extra Vassal Limit from ruler and spouse diplomacy
	...
	ASK_FOR_CRUSADE_INTERACTION_ENABLED = 0,						-- Should this action be used at all?		
...
NCharacter = {
	...
	INFANT_DEATH_CHANCE = 0.0,						-- Chance of stillbirth / death at birth						-- Chance of stillbirth / death at birth
...
NEconomy = {
	...
	OVER_MAX_DEMESNE_TAX_PENALTY = 0.25,			-- Percent penalty per county over the limit		-- Percent penalty per county over the limit
	HOLDING_LOOT_LOWER_LIMIT_MULTIPLIER = 3.0,
	TAX_TO_LOOT_MULTIPLIER = 1.0,					-- Lootable gold per tax 		-- Lootable gold per tax 
...
NMilitary = {
	...
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_RELIGION = 10,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_RELIGIONGROUP = 20,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_CULTURE = 5,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_CULTUREGROUP = 10,
	...
	LIGHT_INFANTRY_PHASE_PURSUE_ATTACK = 0.75,
	LIGHT_INFANTRY_PHASE_SKIRMISH_DEFENSE = 1,
	LIGHT_INFANTRY_PHASE_MELEE_DEFENSE = 0.5,
	LIGHT_INFANTRY_PHASE_PURSUE_DEFENSE = 0.75,
	...
	HEAVY_INFANTRY_PHASE_MELEE_ATTACK = 3,
	HEAVY_INFANTRY_PHASE_PURSUE_ATTACK = 0.5,
	HEAVY_INFANTRY_PHASE_SKIRMISH_DEFENSE = 0.5,
	HEAVY_INFANTRY_PHASE_MELEE_DEFENSE = 2.5,
	HEAVY_INFANTRY_PHASE_PURSUE_DEFENSE = 0.5,
	HEAVY_INFANTRY_GRAPHICAL_FACTOR = 1,

	PIKEMEN_MORALE = 5,
	PIKEMEN_MAINTENANCE = 1.5,
	PIKEMEN_PHASE_SKIRMISH_ATTACK = 0.1,
	PIKEMEN_PHASE_MELEE_ATTACK = 3,
	PIKEMEN_PHASE_PURSUE_ATTACK = 0.3,
	PIKEMEN_PHASE_SKIRMISH_DEFENSE = 0.3,
	PIKEMEN_PHASE_MELEE_DEFENSE = 3,
	PIKEMEN_PHASE_PURSUE_DEFENSE = 0.3,
	...
	LIGHT_CAVALRY_PHASE_PURSUE_ATTACK = 4,
	LIGHT_CAVALRY_PHASE_SKIRMISH_DEFENSE = 1,
	LIGHT_CAVALRY_PHASE_MELEE_DEFENSE = 1,
	LIGHT_CAVALRY_PHASE_PURSUE_DEFENSE = 3,
	LIGHT_CAVALRY_GRAPHICAL_FACTOR = 1,
	
	KNIGHTS_MORALE = 7,
	KNIGHTS_MAINTENANCE = 2.5,
	KNIGHTS_PHASE_SKIRMISH_ATTACK = 0.5,
	KNIGHTS_PHASE_MELEE_ATTACK = 4,
	KNIGHTS_PHASE_PURSUE_ATTACK = 3,
	KNIGHTS_PHASE_SKIRMISH_DEFENSE = 0.5,
	KNIGHTS_PHASE_MELEE_DEFENSE = 3,
	KNIGHTS_PHASE_PURSUE_DEFENSE = 2,
	KNIGHTS_GRAPHICAL_FACTOR = 1,

	ARCHERS_MORALE = 2,
	ARCHERS_MAINTENANCE = 1,
	ARCHERS_PHASE_SKIRMISH_ATTACK = 2,
	ARCHERS_PHASE_MELEE_ATTACK = 0.25,
	ARCHERS_PHASE_PURSUE_ATTACK = 0.25,
	ARCHERS_PHASE_SKIRMISH_DEFENSE = 3,
	ARCHERS_PHASE_MELEE_DEFENSE = 0.25,
	ARCHERS_PHASE_PURSUE_DEFENSE = 0.25,
	...
	CAPITAL_COUNTY_VASSAL_COUNT_LEVY_MULT = 1.25,	-- Used instead of CAPITAL_COUNTY_LEVY_MULT for vassal counts
	CAPITAL_COUNTY_VASSAL_LEVY_MULT = 1.5,		-- Used instead of CAPITAL_COUNTY_LEVY_MULT for non-count vassals
	CAPITAL_COUNTY_LEVY_MULT = 1.5,				-- Multiplier to direct levies in the capital county
	CAPITAL_COUNTY_LIEGE_LEVY_MULT = 1.25,			-- Multiplier to liege levies in the capital county
	...
	CAPITAL_KINGDOM_LIEGE_LEVY_MULT = 0.75,
...
NEngine = {
	...
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_YEAR = 417, -- The missing scripted successor error will not be shown before this date
...
NFrontend = 
{
	CAMERA_LOOKAT_X = 1800.0, 			-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1800.0,
	CAMERA_LOOKAT_SETTINGS_X = 3500.0,  -- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,		-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1000.0,
	CAMERA_START_X = 4200.0,				-- Initial position in main menu
	CAMERA_START_Y = 250.0,				-- Y is height
	CAMERA_START_Z = 1500.0,
	CAMERA_END_X = 1800.0,				-- Move to position in main menu
	CAMERA_END_Y = 200.0,
	CAMERA_END_Z = 1400.0,
	...
	FRONTEND_POS_Y = 200.0,
	FRONTEND_POS_Z = 1500.0,
	FRONTEND_LOOK_X = 1350.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1775.0,
	
	SETTINGS_POS_X = 3000.0,
	SETTINGS_POS_Y = 200.0,
	SETTINGS_POS_Z = 1300.0,
	SETTINGS_LOOK_X = 3600.0,
	SETTINGS_LOOK_Y = 0.0,		
	SETTINGS_LOOK_Z = 1750.0,
	
	MP_OPTIONS_POS_X = 1700.0,
	MP_OPTIONS_POS_Y = 200.0,
	MP_OPTIONS_POS_Z = 1400.0,
	MP_OPTIONS_LOOK_X = 1200.0,
	MP_OPTIONS_LOOK_Y = 0.0,	
	MP_OPTIONS_LOOK_Z = 1900.0,
	
	TUTORIAL_POS_X = 1500.0,
	TUTORIAL_POS_Y = 200.0,
	TUTORIAL_POS_Z = 1400.0,
	TUTORIAL_LOOK_X = 450.0,
	TUTORIAL_LOOK_Y = 0.0,	
	TUTORIAL_LOOK_Z = 1650.0,
	
	CREDITS_POS_X = 2300.0,
	CREDITS_POS_Y = 200.0,
	CREDITS_POS_Z = 1300.0,
	CREDITS_LOOK_X = 2800.0,
	CREDITS_LOOK_Y = 0.0,	
	CREDITS_LOOK_Z = 1750.0,
},
